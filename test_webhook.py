...
# Your webhook URL (corrected with single slash)
WEBHOOK_URL = "https://rdsiva.duckdns.org/telegram/webhook"
...
async def test_webhook():
    ...
    try:
        ...
        if new_webhook_info.last_error:
            logger.error(f"❌ Last webhook error: {new_webhook_info.last_error}")
