...
class PricePredictionModel:
    ...
    def _get_training_data(self):
        ...
        with app.app_context():
            ...
            history = PriceHistory.query.filter(
                ...
                PriceHistory.provider == "ComEd"  # Ensure we only get ComEd prices
    ...
    def predict(self, current_price, timestamp=None):
        ...
        try:
            ...
            # Calculate confidence score based on feature importance and historical accuracy
